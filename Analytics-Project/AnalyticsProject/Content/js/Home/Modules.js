...
$(function() {
	...
	//	config('/widgets/AnalyticsSummary', analyticsWidget, function() {
			$('.ga_visits', analyticsWidget).sparkline(ga_visits, { type:'line', width:'100%', height:'75px', lineColor:'#999', fillColor:'#eee', spotColor:true, minSpotColor:true, maxSpotColor:true, chartRangeMin:0 });
	//	});
	//}
